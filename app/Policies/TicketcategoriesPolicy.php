...
class TicketcategoriesPolicy
{
    ...
    {
        return $user->can('view_any_kategori::tikets');
    }
    ...
    {
        return $user->can('create_kategori::tikets');
    }
    ...
    {
        return $user->can('delete_any_kategori::tikets');
    }
    ...
    {
        return $user->can('force_delete_any_kategori::tikets');
    }
    ...
    {
        return $user->can('restore_any_kategori::tikets');
    }
    ...
    {
        return $user->can('reorder_kategori::tikets');
    }
}
